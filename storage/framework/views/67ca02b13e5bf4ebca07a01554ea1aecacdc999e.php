...
} elseif ($_instance->childHasBeenRendered('UJeC28W')) {
    $componentId = $_instance->getRenderedChildComponentId('UJeC28W');
    $componentTag = $_instance->getRenderedChildComponentTagName('UJeC28W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UJeC28W');
} else {
    $response = \Livewire\Livewire::mount('dashboard-form');
    $html = $response->html();
    $_instance->logRenderedChild('UJeC28W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CloudAppLaravel\CloudAppLaravel\resources\views/Client/home.blade.php ENDPATH**/ ?>