...
<link rel="stylesheet" type="text/css" href="<?php echo e(Path::asset('admin/plugins/dropify/dropify.min.css')); ?>">
<link href="<?php echo e(Path::asset('admin/assets/css/users/account-setting.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <div class="account-settings-container layout-top-spacing">
        ...
        <div class="account-content">
            <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                ...
                <form action="<?php echo e(route('settings.store')); ?>" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                    <div class="row" style="width: 90%; margin: auto;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" name="company_name" value="<?php echo e($settings->company_name); ?>" id="fullName" placeholder="Full Name" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)"    readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="fullName" style="color:var(--blackText)"> Company's ID</label>
                                                                    <input type="text" class="form-control mb-4" name="company_ID" value="<?php echo e($settings->company_ID); ?>" id="fullName" placeholder="Full Name" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)"    READONLY>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" name="company_plan" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)"     >
                                                                        <option value="<?php echo e($settings['plan_id']); ?>"><?php echo e($settings['plan']['name']); ?></option>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group mr-1">
                                                                    ...
                                                                    <input type="date" class="form-control mb-4" name="expiry_date" value="<?php echo e($settings->expiry_date); ?>" id="fullName" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-11 mx-auto">
                                            <div class="row">
                                                <div class="col-xl-2 col-lg-12 col-md-4">
                                                    <div class="upload mt-4 pr-md-4">
                                                        <input type="file" id="input-file-max-fs" name="file2" class="dropify" data-default-file="<?php echo e(Path::asset('images/'.$contact->image)); ?>" data-max-file-size="2M" />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4" name="contact_name" value="<?php echo e($contact->name); ?>" id="fullName" placeholder="Contact Person Full Name" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)" >
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="fullName" style="color:var(--blackText)">Contact Person Phone</label>
                                                                    <input type="tel" class="form-control mb-4" name="contact_phone" value="<?php echo e($contact->phone); ?>" placeholder="Contact Person Phone Number" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)" >
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group mr-1">
                                                                    <label for="fullName" style="color:var(--blackText)">Contact Person Email</label>
                                                                    <input type="email" class="form-control mb-4" name="contact_email" value="<?php echo e($contact->email); ?>" placeholder="Contact Person Email" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('industry', [$settings->industry_id])->html();
} elseif ($_instance->childHasBeenRendered('P3yYSlQ')) {
    $componentId = $_instance->getRenderedChildComponentId('P3yYSlQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('P3yYSlQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('P3yYSlQ');
} else {
    $response = \Livewire\Livewire::mount('industry', [$settings->industry_id]);
    $html = $response->html();
    $_instance->logRenderedChild('P3yYSlQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                ...
                                                                                <input  id="to_zip" class="sectionVisibility" type="checkbox" <?php if($settings->to_zip == true): ?> checked <?php endif; ?>>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">OFF</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;ON</span>
                                                                                <input  id="to_csv" class="sectionVisibility" type="checkbox" <?php if($settings->to_csv == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="card component-card_1" style="background-color:var(--inputBackground)">
                                                                <div class="card-body">
                                                                    <h3 class="text-center" style="color:var(--blackText)">Country Time  <small>(GMT)</small></h3>
                                                                        <p style="font-size:15px; text-align: center; text-success"> <span id="databaseCountry"><?php echo e($settings->countryName($settings->country)); ?></span> <span id="newCountry"></span> </p>
                                                                    <div style="display: flex; justify-content: center; align-items: center; text-align:center; ">
                                                                        <ul style="margin-left: -40px; margin-top: 20px;margin-bottom:20px;list-style-type: none;" id="menu">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="time_type" id="time_type" onchange="getPreTime(this)" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                    <option value="<?php echo e($settings->time_type); ?>">
                                                                        <?php if($settings->time_type == 0): ?>
                                                                        Server Time
                                                                        <?php elseif($settings->time_type == 2): ?>
                                                                        Country Time
                                                                        <?php else: ?>
                                                                        Device Time
                                                                        <?php endif; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="country" id="country" onchange="getContryCodeValue(this)" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                    <option value="<?php echo e($settings->country); ?>"><?php echo e($settings->countryName($settings->country)); ?></option>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="time_zone" class="form-control mb-4" id="selected_hour" value="<?php echo e($settings->time_zone); ?>" placeholder="Time Zone" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)" readonly>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="announcement" class="form-control mb-4" value="<?php echo e($tabs->announcement); ?>" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                ...
                                                                                <input  id="announce" class="sectionVisibility" type="checkbox" <?php if($settings->show_announcement == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                         <button class="btn btn-success" type="submit" style="display: block; margin:30px 30px 30px 0px;float:right; ">
                            ...
                            <div id="general-info" class="section general-info">
                                <div class="info">
                                    <h6 class="" style="color:var(--blackText)"><?php echo e($tabs->training); ?></h6>
                                    <div class="row">
                                        <div class="col-lg-11 mx-auto">
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                                                    <div class="form">
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label for="fullName" style="color:var(--blackText)"><?php echo e($tabs->training); ?> Tab Name</label>
                                                                    <input type="text" name="training" value="<?php echo e($tabs->training); ?>" class="form-control mb-4" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                    <label style=" display:block; text-align: center; margin:auto; color:var(--blackText)"><?php echo e($tabs->training); ?> page </label>
                                                                        <Br>
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input  id="training" class="sectionVisibility" type="checkbox" <?php if($settings->show_training == true): ?> checked <?php endif; ?> >
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <label style=" display:block; text-align: center; margin:auto; color:var(--blackText)">Freeze Time</label>
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">OFF</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;ON</span>
                                                                                <input  id="freeze_time" class="sectionVisibility" type="checkbox" <?php if($settings->freeze_time == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <input id="morning" class="sectionVisibility" type="checkbox" <?php if($settings->morning == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                            <br>
                                                                        </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <input id="afternoon" class="sectionVisibility" type="checkbox" <?php if($settings->afternoon == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                            <br>
                                                                        </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <input id="evening" class="sectionVisibility" type="checkbox" <?php if($settings->evening == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                            <br>
                                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="news_title" value="<?php echo e($tabs->news_title); ?>" class="form-control mb-4" placeholder="Enter News Title" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="allow_custom_news" class="sectionVisibility" type="checkbox" <?php if($settings->allow_custom_news == true): ?> checked <?php endif; ?>><span class="slider round"></span>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="allow_rss_news" class="sectionVisibility" type="checkbox" <?php if($settings->allow_rss_news == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="show_template" class="sectionVisibility" type="checkbox" <?php if($settings->show_template == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="show_logo" class="sectionVisibility" type="checkbox" <?php if($settings->show_logo == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="show_banner" class="sectionVisibility" type="checkbox" <?php if($settings->show_banner == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="show_clock" class="sectionVisibility" type="checkbox" <?php if($settings->show_clock == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="show_rate" class="sectionVisibility" type="checkbox" <?php if($settings->show_rate == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="show_news" class="sectionVisibility" type="checkbox" <?php if($settings->show_news == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Hide</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;Show</span>
                                                                                <input id="allow_scheduling" class="sectionVisibility" type="checkbox" <?php if($settings->allow_scheduling == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Off</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;ON</span>
                                                                                <input id="add_display" class="sectionVisibility" type="checkbox" <?php if($settings->add_display == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Off</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;ON</span>
                                                                                <input id="add_location" class="sectionVisibility" type="checkbox" <?php if($settings->add_location == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div style=" display:block; text-align: center; margin:auto">
                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                <span style=" margin-left: -100px">Off</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <span style=" margin-right: -100px;" class="text-success">&nbsp;&nbsp;&nbsp;&nbsp;ON</span>
                                                                                <input id="show_company_branding" class="sectionVisibility" type="checkbox" <?php if($settings->show_company_branding == true): ?> checked <?php endif; ?>>
                                                                                <span class="slider round"></span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
...
} elseif ($_instance->childHasBeenRendered('deDQPJ2')) {
    $componentId = $_instance->getRenderedChildComponentId('deDQPJ2');
    $componentTag = $_instance->getRenderedChildComponentTagName('deDQPJ2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('deDQPJ2');
} else {
    $response = \Livewire\Livewire::mount('sections');
    $html = $response->html();
    $_instance->logRenderedChild('deDQPJ2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('training-settings')->html();
} elseif ($_instance->childHasBeenRendered('ZCuUimk')) {
    $componentId = $_instance->getRenderedChildComponentId('ZCuUimk');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZCuUimk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZCuUimk');
} else {
    $response = \Livewire\Livewire::mount('training-settings');
    $html = $response->html();
    $_instance->logRenderedChild('ZCuUimk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="<?php echo e(Path::asset('admin/plugins/dropify/dropify.min.js')); ?>"></script>
<script src="<?php echo e(Path::asset('admin/plugins/blockui/jquery.blockUI.min.js')); ?>"></script>
<!-- <script src="<?php echo e(Path::asset('admin/plugins/tagInput/tags-input.js')); ?>"></script> -->
<script src="<?php echo e(Path::asset('admin/assets/js/users/account-settings.js')); ?>"></script>
<script src="<?php echo e(Path::asset('time/moment.min.js')); ?>"></script>
<script src='https://cdnjs.cloudflare.com/ajax/libs/moment-timezone/0.5.3/moment-timezone-with-data.min.js'></script>

<script>
    window.onload = function() {
        function getPreTime1() {
            var value = '<?php echo e($settings->time_type); ?>';
            if (value == 1) {
                $('#ST').hide();
                $('#CT').hide();
            }
...
<script>
    $(document).ready(function() {
        ...
        $(".trainingSection").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('trainingBtn')); ?>",
                data: {
                    id: id,
                    status: status,
                    _token: _token
        ...
        $(".zones").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('zoneSwitch')); ?>",
                data: {
                    id: id,
                    status: status,
                    _token: _token
        ...
        $(".sectionVisibility").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('pageVisibilityControl')); ?>",
                data: {
                    id: id,
                    status: status,
                    _token: _token
...
<script>
    ...
    function getTime(timeZone = add) {
        ...
        if (timeZone == 0) {
            $.ajax({
                url: "<?php echo e(env('APP_URL')); ?>/api/get_server_time",
                data: {},
            ...
            $.ajax({
                url: "<?php echo e(env('APP_URL')); ?>/api/get_raw_server_time",
                data: {},
                success: function(data) {
                    if (data != "") {
                        let res = JSON.parse(data)
...
<?php echo $__env->make('layouts.client.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CloudAppLaravel\CloudAppLaravel\resources\views/superadmin/global_settings.blade.php ENDPATH**/ ?>