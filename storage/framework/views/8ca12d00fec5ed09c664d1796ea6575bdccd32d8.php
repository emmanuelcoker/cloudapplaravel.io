...
<body style="background-color:<?php echo e($settings->tv_background); ?>" changePageID="<? echo rand(); ?>">
    ...
    <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($media->content_type == 'schedule'): ?>
                            <?php if($media->type == 'video'): ?>
                            <a href="videobank/item<?php echo e($media->file); ?>.mp4"><img src="logo/logo01.png" alt="item<?php echo e($media->file); ?>"></a>
                            <?php endif; ?>
                            <?php if($media->type == 'image'): ?>
                            <a href="videobank/item<?php echo e($media->file); ?>.png"><img src="logo/logo01.png" alt="item<?php echo e($media->file); ?>"></a>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php if($media->content_type == 'master'): ?>
                            <?php if($media->type == 'video'): ?>
                            <a href="video/item<?php echo e($media->file); ?>.mp4"><img src="logo/logo01.png" alt="item<?php echo e($media->file); ?>"></a>
                            <?php endif; ?>
                            <?php if($media->type == 'image'): ?>
                            <a href="video/item<?php echo e($media->file); ?>.png"><img src="logo/logo01.png" alt="item<?php echo e($media->file); ?>"></a>
                            <?php endif; ?>
                            <?php endif; ?>
                ...
                <div class="row underVideo" style="margin-top:-10px">
                    <div class="col-md-2 padRightOff" style="margin-top: -4.6px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div>
                                    <h4 class="myHeader1" style="line-height: 30px;">&nbsp;&nbsp;&nbsp;  <?php echo e($tab->news_title); ?> </h4>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <a data-target=".check-networ" id="template_logo" data-toggle="modal" id="check-network" type="button">
                                    ...
                                    <?php $__currentLoopData = $logos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div><img src="logo/logo<?php echo e($logo->image.'.'.$logo->extension); ?>" alt="" title="" /></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                        
                                    </div>
                    ...
                    <div class="col-md-10 ">
                        ...
                        <marquee id="mymarquee" style="margin-top: 0px">
                                <?php $__currentLoopData = $custom_news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($news->is_active): ?>
                                <img src="rss/images/<?php echo e($news->image); ?>" style=" border-radius:38%; width:40px; height:40px"></img> <?php echo e($news->name); ?>
                                ...
                                <?php $__currentLoopData = $rss_news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($news->is_active): ?>
                                <img src="rss/images/<?php echo e($news->image); ?>" style=" border-radius:38%; width:40px; height:40px"></img> <?php echo e($news->name); ?>

                                <div class='vl'></div>
                                &nbsp;<?php echo e(Rss::output_rss_feed($news->link, $news->count)); ?> &nbsp;
                                <div class='vl'></div>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </marquee>
                        ...
                        <div class="row">
                            ...
                            <div><img src="banner/banner<?php echo e($banner->file); ?>.<?php echo e($banner->extension); ?>" alt="" title="" /></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                            <div class="col-md-4 padLeftOff">
                            <?php if($tv->clockLayout == 5): ?>
                            <?php if($tv->show_date_image == 1): ?>
                <div class="tm" style="margin-top: 0%;  margin-left:-15px; background-image: url('time/<?php echo e($tv->clockImage); ?>'); background-size: 100% 100%;">
                    <?php endif; ?>

                    <?php if($tv->show_date_image == 0): ?>
                    <div class="tm" style="margin-top: 0%;  margin-left:-15px; background:<?php echo e($tv->clock_background_color); ?>; padding-bottom:13px">
                        <?php endif; ?>
...
<p id="minute"></p> -->
                    ...
                    <?php else: ?>
                                <iframe  src="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('clock/'.$tv->clockLayout.'/index.html')); ?>" scrolling="no" style=" width: 107%; height: 100%; border: none; margin:0px 0px 0px -30px; padding: 0; overflow:hidden;  "></iframe>
                                <?php endif; ?>
                </div>
                    ...
                    <div class="modal-body mysettings form-signin">
                        ...
                        <div class="row">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist" style="align-items:center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="hide2" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><?php echo e($tab->announcement); ?> & <?php echo e($tab->training); ?></a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="row" style="height: 20vh" id="fol">
                                    ...
                                    <div style="font-size:20px;font-weight: bolder; margin-top: 30px;margin-left: 90px">
                                        <img src="logo/<?php echo e($tv->localUpdateLogo); ?>" alt="" title="" style="width: 92%;
height: 400px;object-fit: cover;" />
                                    </div>
                                </div>
                                <div class="tab-pane fade active" id="home" role="tabpanel" aria-labelledby="home-tab">

                                    <?php if($tv->interest_rate_type == 0): ?>
                                    <div class="col-md-4">
                                    ...
                                    <?php if($tv->interest_rate_type == 1): ?>
                                    <div class="col-md-3">
                                        <h5 class="card-title text-center" style="margin-bottom: 30px"> Rate Guide</h5>
                                        <div id="dynamic_exchange_body1"></div>
                                    </div>
...
Sorry your browser does not support inline frames.
                                            ...
                                            <div class="row" style="margin-top: 2px;">
                                                ...
                                                <div class="col-md-4" style="margin-top: 6%">
                                                    <a href="./announce.html" style="color: white;font-size: 30px" target="_blank">
                                                        <button class="btn btn-lg btn-primary btn-block text-uppercase"><?php echo e($tab->announcement); ?></button></a>
                                                </div>
                                                <div class="col-md-4"></div>
                                            ...
                                            <div class="row" style="margin-top: 3px;">
                                                ...
                                                <div class="col-md-4" style="margin-top: 2%">
                                                    <a href="./morning.html" style="color: white;font-size: 30px" target="_blank">
                                                        <button class="btn btn-lg btn-primary btn-block text-uppercase">Morning <?php echo e($tab->training); ?></button></a>
                                                </div>
                                                <div class="col-md-4"></div>
                                            </div>
                                            <div class="row" style="margin-top: 3px;">
                                                ...
                                                <div class="col-md-4" style="margin-top: 2%">
                                                    <a href="./afternoon.html" style="color: white;font-size: 30px" target="_blank">
                                                        <button class="btn btn-lg btn-primary btn-block text-uppercase">Afternoon <?php echo e($tab->training); ?></button></a>
                                                </div>
                                                <div class="col-md-4"></div>
                                            </div>
                                            <div class="row" style="margin-top: 3px;">
                                                ...
                                                <div class="col-md-4" style="margin-top: 2%">
                                                    <a href="./evening.html" style="color: white;font-size: 30px" target="_blank">
                                                        <button class="btn btn-lg btn-primary btn-block text-uppercase">Evening <?php echo e($tab->training); ?></button></a>
                                                </div>
                                                <div class="col-md-4"></div>
                                            </div>
                                        </div>
        ...
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('train/item01.png')); ?>"></a>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('index.html')); ?>?nocache=<?php echo rand(100, 998000); ?>"></a>
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('announce.html')); ?>"></a>
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('morning.html')); ?>"></a>
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('afternoon.html')); ?>"></a>
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('evening.html')); ?>"></a>

        <?php $__currentLoopData = $tv['trainingVideos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('train/item'.$video->video.'.mp4')); ?>"></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('announce/announce.png')); ?>"></a>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('scheduledplaylist/scheduleplaylist.xlsx')); ?>"></a>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('multimedia/index.html')); ?>"></a>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('templates/templatestyle.xlsx')); ?>"></a>

        <?php if($tv->clockLayout != 1): ?>
            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('clock/1/index.html')); ?>"></a>
        <?php endif; ?>
        <?php if($tv->clockLayout != 2): ?>
            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('clock/2/index.html')); ?>"></a>
        <?php endif; ?>
        <?php if($tv->clockLayout != 3): ?>
            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('clock/3/index.html')); ?>"></a>
        <?php endif; ?>
        <?php if($tv->clockLayout != 4): ?>
            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('clock/4/index.html')); ?>"></a>
        <?php endif; ?>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('webview2/index.html')); ?>"></a>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('rss/news.xlsx')); ?>"></a>

        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('time/time.png')); ?>"></a>
        <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('videobank')); ?>"></a>



        <?php $__currentLoopData = $waitingMediaItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($item->type == 'video'): ?>
                <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('videobank/item'.$item->file.'.mp4')); ?>"></a>
                <?php endif; ?>
                <?php if($item->type == 'image'): ?>
                <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('videobank/item'.$item->file.'.png')); ?>"></a>
                <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($media->content_type == 'schedule'): ?>
                            <?php if($media->type == 'video'): ?>
                            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('videobank/item'.$media->file.'.mp4')); ?>"></a>
                            <?php endif; ?>
                            <?php if($media->type == 'image'): ?>
                            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('videobank/item'.$media->file.'.png')); ?>"></a>
                            <?php endif; ?>
                            <?php endif; ?>

                            <?php if($media->content_type == 'master'): ?>
                            <?php if($media->type == 'video'): ?>
                            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('video/item'.$media->file.'.mp4')); ?>"></a>
                            <?php endif; ?>
                            <?php if($media->type == 'image'): ?>
                            <a href="<?php echo e($app_url); ?><?php echo e(Variables::tvPath('video/item'.$media->file.'.png')); ?>"></a>
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <script>
            $(function() {
                ...
                $('#offline').click(function() {
                    // if(!$('#iframe').length) {
                    $('#ubaiframeHolder').html('<iframe id=\'<?php echo e($app_url); ?><?php echo e(Variables::tvPath("index.html")); ?>\' src=\'<?php echo e($app_url); ?><?php echo e(Variables::tvPath("index.html")); ?>\' width="100%" height="100%" scrolling="yes" style="-webkit-transform:scale(1.0);-moz-transform-scale(1.0);"></iframe>');
                    // }
                });
            });
            // function hide(){
        ...
        <script>
            window.setInterval(function() {
                ...
                if (month == '<?php echo e($mediaStartMonth - 1); ?>' && day == '<?php echo e($mediaStartDay); ?>' && hours == '<?php echo e($mediaStartHour); ?>' && minutes == '<?php echo e($mediaStartMin); ?>' && second == 1) {
                    console.log('run add schedule');
                    var update_url = '<?php echo e($api_url); ?>/api/run-schedule';
                    $.ajax({
                        url: update_url,
                        data: {
                            tv: '<?php echo e($tv->id); ?>',
                            mediaItem: '<?php echo e($schedule->id); ?>',
                            operation: 'add'
                        },
                        error: function(e) {
                            console.log(e);
                        ...
                        success: function(data) {
                            console.log(data);
                            console.log('item <?php echo e($schedule->id); ?> addedd');
                            location.reload();
                        },
                        type: 'POST'
                    });
        ...
        <script>
            window.setInterval(function() {
                ...
                var minutes = date.getMinutes();
                var second = date.getSeconds();
                if (month == '<?php echo e($mediaEndMonth - 1); ?>' && day == '<?php echo e($mediaEndDay); ?>' && hours == '<?php echo e($mediaEndHour); ?>' && minutes == '<?php echo e($mediaEndMin); ?>' && second == 1) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            console.log(data);
                            console.log('item <?php echo e($schedule->id); ?> removed');
                            location.reload();
                        },
                        type: 'POST'
                    });
        ...
        <?php if($settings->show_announcement == true): ?>
        ...
        <script>
            ...
            window.setInterval(function() {
                ...
                var minutes = date.getMinutes();
                var second = date.getSeconds();
                if (myday == '<?php echo e($day); ?>' && hours == '<?php echo e($hour); ?>' && minutes == '<?php echo e($min); ?>' && second == 1) {
        ...
        <script>
            window.setInterval(function() {
                ...
                var hours = date.getHours();
                var minutes = date.getMinutes();
                if (myday == '<?php echo e($endDay); ?>' && hours == '<?php echo e($endHour); ?>' && minutes == '<?php echo e($endMin); ?>') {
                    $('#parent').remove();
                }
            }, 1000);
        </script>
        ...
        <!-- training -->
        <?php if($settings->show_training == true): ?>
        <!-- NOTE:
1 - monday
2 - tuesday
3 - wednesday
...
</html><?php /**PATH C:\xampp\htdocs\CloudAppLaravel\CloudAppLaravel\resources\views/template/displays/semi_fx.blade.php ENDPATH**/ ?>