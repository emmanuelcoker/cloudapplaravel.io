                                    ...
                                    <table style="width: 100%; font-size: 15px; margin-top: 10px; margin-left:20px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <svg wire:click="deleteRole('<?php echo e($role->id); ?>')" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2">
...
</div><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/livewire/roles.blade.php ENDPATH**/ ?>