...
<!-- <link href="<?php echo e(Path::asset('admin/plugins/flatpickr/flatpickr.css')); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo e(Path::asset('admin/plugins/noUiSlider/nouislider.min.css')); ?>" rel="stylesheet" type="text/css"> -->
<!-- END THEME GLOBAL STYLES -->

<!--  BEGIN CUSTOM STYLE FILE  -->
<!-- <link href="<?php echo e(Path::asset('admin/assets/css/scrollspyNav.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(Path::asset('admin/plugins/flatpickr/custom-flatpickr.css')); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo e(Path::asset('admin/plugins/noUiSlider/custom-nouiSlider.css')); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo e(Path::asset('admin/plugins/bootstrap-range-Slider/bootstrap-slider.css')); ?>" rel="stylesheet" type="text/css"> -->

<link href="<?php echo e(Path::asset('admin/plugins/sweetalerts/sweetalert2.min.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(Path::asset('admin/plugins/sweetalerts/sweetalert.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(Path::asset('admin/assets/css/components/custom-sweetalert.css')); ?>" rel="stylesheet" type="text/css" />

<link rel="stylesheet" type="text/css" href="<?php echo e(Path::asset('admin/assets/css/forms/switches.css')); ?>">
<link href="<?php echo e(Path::asset('admin/plugins/drag-and-drop/dragula/dragula.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(Path::asset('admin/plugins/drag-and-drop/dragula/example.css')); ?>" rel="stylesheet" type="text/css" />
            ...
            <div class="widget-content searchable-container list">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                        ...
                        <div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
                            <div class="modal-dialog <?php if(Permission::check('can_upload_media_contents')): ?> modal-xl <?php endif; ?> modal-dialog-centered" role="document">
                                <div class="modal-content" style="background:var(--dashboardCard)">
                                    <form id="addContactModalTitle" method="post" action="<?php echo e(route('media.store')); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="add-contact-box">
                                                <div class="add-contact-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="<?php if(Permission::check('can_upload_media_contents')): ?> col-md-6 <?php else: ?> col-md-12 <?php endif; ?>">
                                                            <div class="row"><br>
                                                            <?php if(Permission::check('can_upload_media_contents')): ?>
                                                                <div class="col-md-12">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog  modal-dialog-centered" role="document">
                                <div class="modal-content" style="background:var(--dashboardCard)">
                                    ...
                                    <form method="post" action="<?php echo e(route('media.schedule')); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                                        <div class="modal-body">
                                            <i class="flaticon-cancel-12 close" data-dismiss="modal"></i>
                                            <div class="add-contact-box">
                                                <div class="add-contact-content">
                ...
                <div class="widget-content widget-content-area rounded-pills-icon">
                    ...
                    <ul class="nav nav-pills mb-4 mt-3  justify-content-center" id="rounded-pills-icon-tab" role="tablist">
                        ...
                        <?php if($setting->allow_scheduling): ?>
                        <li class="nav-item ml-2 mr-2">
                    ...
                    <div class="tab-content" id="rounded-pills-icon-tabContent">
                                                        ...
                                                        <div class='row'>
                                                            <div style="width: 100%;">
                                                                ...
                                                                <div id='mediaDrag' class='dragula' style="width: 100%;">
                                                                    ...
                                                                    <div class="media   d-block d-sm-flex" style="width: 100%;" data-index="<?php echo e($playlist->id); ?>" data-position="<?php echo e($playlist->position); ?>">
                                                                        <div <?php if($playlist->position < 10): ?> class="numberCircle" <?php else: ?> class="numberCircle1" <?php endif; ?>><?php echo e($playlist->position); ?></div>
                                                                            <?php if($playlist->content_type == 'schedule'): ?>
                                                                            <?php if($playlist->type == 'image'): ?>
                                                                            <img src="<?php echo e(Variables::tvPath('videobank/item'.$playlist->file.'.'.$playlist->extension)); ?>" style="width:70px; height:70px; margin-left: 40px; border:0px; border-radius: 0px;" alt="">
                                                                            <?php else: ?>
                                                                            <video src="<?php echo e(Variables::tvPath('videobank/item'.$playlist->file.'.'.$playlist->extension)); ?>" style="margin-left: 40px; width:70px; height:70px; margin-top:-10px "> </video>
                                                                            &nbsp;&nbsp;
                                                                            <?php endif; ?>
                                                                            <?php else: ?>
                                                                            <?php if($playlist->type == 'image'): ?>
                                                                            <img src="<?php echo e(Variables::tvPath('video/item'.$playlist->file.'.'.$playlist->extension)); ?>" style="width:70px; height:70px; margin-left: 40px; border:0px; border-radius: 0px;" alt="">
                                                                            <?php else: ?>
                                                                            <video src="<?php echo e(Variables::tvPath('video/item'.$playlist->file.'.'.$playlist->extension)); ?>" style="margin-left: 40px; width:70px; height:70px; margin-top:-10px "> </video>
                                                                            &nbsp;&nbsp;
                                                                            <?php endif; ?>
                                                                            <?php endif; ?>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <div class="media-body">
                                                                            <div class="d-flex justify-content-between" style="width:100%">
                                                                                <div class="" style="width:60%">
                                                                                    <h6 class="" style="color:var(--blackText)"><?php echo e($playlist->title); ?></h6>
                                                                                    <p class="" style="width: 100px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis"><span style="color:var(--primary)">item<?php echo e($playlist->file); ?></span></p>
                                                                                </div>
                                                                                <div class="" style="width:50%; text-align:center">
                                                                                    <?php if($playlist->content_type == 'schedule'): ?>
                                                                                    <?php if(strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) <= strtotime($playlist->start) && strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) < strtotime($playlist->end)): ?>
                                                                                            <div class="classSchedule classDefault">Scheduled Media</div>
                                                                                            <?php elseif(strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) >= strtotime($playlist->start) && strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) < strtotime($playlist->end)): ?>
                                                                                    ...
                                                                                    <div style="display: inline-block;">
                                                                                        <div style="margin-top: 13px;">
                                                                                            <label class="switch s-outline s-outline-success  mb-4 mr-2">
                                                                                                <input id="<?php echo e($playlist->id); ?>" class="mediaSwitch" type="checkbox" <?php if($playlist->is_active == true): ?> checked <?php endif; ?>>
                                ...
                                <div class="items">
                                    <div class="item-content">
                                        <div class="user-profile" style="width: 25%; text-align: left;">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#addContactModal" onclick="var id = '<?php echo e($media->id); ?>';  
                                            var description = '<?php echo e($media->description); ?>'; 
                                            var type = '<?php echo e($media->type); ?>'; 
                                            document.getElementById('mediaID').value = id;
                                            type == 'image'   ?  document.getElementById('showLastImage').innerHTML = '<img src=\'<?php echo e(Variables::tvPath("video/item".$media->file.".".$media->extension)); ?>\' style=\'max-width: 50%; display:block; margin: auto;\'  >'
                                            :
                                            document.getElementById('showLastImage').innerHTML = '<video controls src=\'<?php echo e(Variables::tvPath("video/item".$media->file.".".$media->extension)); ?>\' style=\'max-width: 50%; display:block; margin: auto;\' > </video>'; 
                                            document.getElementById('descMedia').value = description;
                                            document.getElementById('c-occupation').value = '<?php echo e($media->title); ?>';
                                            ">
                                                <?php if($media->type == 'image'): ?>
                                                <img src="<?php echo e(Variables::tvPath('video/item'.$media->file.'.'.$media->extension)); ?>" style="width:70px; height:70px; margin-left: 40px;" alt="">
                                                <?php else: ?>
                                                <video src="<?php echo e(Variables::tvPath('video/item'.$media->file.'.'.$media->extension)); ?>" style="margin-left: 40px; width:70px; height:70px; margin-top:-10px "> </video>
                                                &nbsp;&nbsp;
                                                <?php endif; ?>
                                            </a>
                                        </div>
                                        ...
                                        <div class="user-email" style="width: 25%; text-align: center;">
                                            <div class="user-meta-info">
                                                <p class="user-name" data-name="item<?php echo e($media->file); ?>" style="font-size: 14px; color:var(--tableFontColor)">&nbsp;&nbsp;&nbsp;item<?php echo e($media->file); ?></p>
                                                <p class="user-work" data-occupation="<?php echo e($media->title); ?>">&nbsp;&nbsp;&nbsp;(<?php echo e($media->type); ?>)</p>
                                            </div>
                                        </div>
                                        <div class="user-email" style="width: 25%; text-align: center;">
                                            <p class="usr-email-addr" data-email="<?php echo e($media->title); ?>" style="font-size: 14px; color:var(--tableFontColor); display: block; margin-left: 40px;"><?php echo e($media->title); ?></p>
                                        </div>
                                        <div class="user-email" style="width: 25%; text-align: center; ">
                                            <p class="usr-email-addr" data-email="<?php echo e($media->description); ?>" style="font-size: 14px; color:var(--tableFontColor) ;display: block; margin-left: 40px;"><?php echo e($media->description); ?></p>
                                        </div>


                                        <div class="action-btn" style="width: 25%; text-align: right;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit" onclick=" var id = '<?php echo e($media->id); ?>';  
                                            var description = '<?php echo e($media->description); ?>'; 
                                            var type = '<?php echo e($media->type); ?>'; 
                                            document.getElementById('mediaID').value = id;
                                            type == 'image'   ?  document.getElementById('showLastImage').innerHTML = '<img src=\'<?php echo e(Variables::tvPath("video/item".$media->file.".".$media->extension)); ?>\' style=\'max-width: 50%; display:block; margin: auto;\'  >'
                                        ...
                                        <div class="items">
                                            <div class="item-content">
                                                <div class="user-profile" style="width: 16.6%; text-align: left;">
                                                    ...
                                                    <?php if($schedule->type == 'image'): ?>
                                                    <img src="<?php echo e(Variables::tvPath('videobank/item'.$schedule->file.'.png')); ?>" style="width:70px; height:70px; margin-left: 40px;" alt="">
                                                    <?php else: ?>
                                                    <video src="<?php echo e(Variables::tvPath('videobank/item'.$schedule->file.'.mp4')); ?>" style="margin-left: 40px; width:70px; height:70px; margin-top:-10px "> </video>
                                                    &nbsp;&nbsp;
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="user-email" style="width: 16.6%; text-align: center;">
                                                    <div class="user-meta-info">
                                                        <p class="user-name" data-name="item<?php echo e($schedule->file); ?>" style="font-size: 14px; color:var(--tableFontColor)">&nbsp;&nbsp;&nbsp;item<?php echo e($schedule->file); ?></p>
                                                        <p class="user-work" data-occupation="<?php echo e($schedule->title); ?>">&nbsp;&nbsp;&nbsp;(<?php echo e($schedule->type); ?>)</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="user-email" style="width: 16.6%; text-align: center;">
                                                    ...
                                                    <p class="usr-email-addr" style="font-size: 14px; color:var(--tableFontColor); margin-left: 40px;">
                                                        <?php echo e(date('d-m-Y', strtotime($schedule->start))); ?> <br> Time: <?php echo e(date('H:i', strtotime($schedule->start))); ?>
                                                ...
                                                <div class="user-email" style="width: 16.6%; text-align: center;">
                                                    ...
                                                    <p class="usr-email-addr" style="font-size: 14px; color:var(--tableFontColor); margin-left: 40px;">
                                                        <?php echo e(date('d-m-Y', strtotime($schedule->end))); ?> <br> Time: <?php echo e(date('H:i', strtotime($schedule->end))); ?>
                                                ...
                                                <div class="user-location" style="width: 16.6%; text-align: center; padding-left:40px ">
                                                    ...
                                                    <?php if(strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) <= strtotime($schedule->start) && strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) < strtotime($schedule->end)): ?>
                                                            <div class="classSchedule1 classDefault">Scheduled</div>
                                                            <?php elseif(strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) >= strtotime($schedule->start) && strtotime(date("Y-m-d H:i:s", strtotime($setting->time_zone.' hour'))) < strtotime($schedule->end)): ?>
                                                ...
                                                <div class="action-btn" style="width: 16.6%; text-align: right;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit" onclick=" var id = '<?php echo e($schedule->id); ?>';  
                                            var description = '<?php echo e($schedule->description); ?>'; 
                                            var type = '<?php echo e($schedule->type); ?>'; 
                                            document.getElementById('mediaID').value = id;
                                            type == 'image'   ?  document.getElementById('showLastImage').innerHTML = '<img src=\'<?php echo e(Variables::tvPath("videobank/item".$schedule->file.".".$schedule->extension)); ?>\' style=\'max-width: 50%; display:block; margin: auto;\'  >'
                                            :
                                            document.getElementById('showLastImage').innerHTML = '<video controls src=\'<?php echo e(Variables::tvPath("videobank/item".$schedule->file.".".$schedule->extension)); ?>\' style=\'max-width: 50%; display:block; margin: auto;\' > </video>'; 
                                            document.getElementById('descMedia').value = description;
                                            ">
                                                        <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                                    </svg>
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href="#" data-toggle="modal" data-target="#exampleModal" onclick="document.getElementById('schduleID').value = '<?php echo e($schedule->id); ?>';  
                                            document.getElementById('scheduleItem').innerHTML = '<?php echo e($schedule->file); ?>';  
                                            document.getElementById('endTime').innerHTML = '<?php echo e(date("d-m-Y", strtotime($schedule->end))." - Time: ".date('H:i', strtotime($schedule->end))); ?>';  
                                            document.getElementById('startTime').innerHTML = '<?php echo e(date("d-m-Y", strtotime($schedule->start))." - Time: ".date('H:i', strtotime($schedule->start))); ?>';">
                        ...
                        <div class="tab-pane fade" id="rounded-pills-icon-profile100" role="tabpanel" aria-labelledby="rounded-pills-icon-profile-tab">
                            <div class="media">
                                <div class="media-body ">
                                    <form method="post" action="<?php echo e(route('media.store')); ?>" enctype="multipart/form-data"> <?php echo csrf_field(); ?>
                                        <div class="searchable-items list">
...
<script>
    $(document).ready(function() {
        $(".mediaSwitch").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('media.switch')); ?>",
                data: {
                    id: id,
                    status: status,
                    _token: _token
...
<script>
    ...
    function saveNewPositions() {
        ...
        $.ajax({
            url: "<?php echo e(route('positioning')); ?>",
            type: 'POST',
            data: {
                update: 1,
                positions: positions,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/Client/media.blade.php ENDPATH**/ ?>