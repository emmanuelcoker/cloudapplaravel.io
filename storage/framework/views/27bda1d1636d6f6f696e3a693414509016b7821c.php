                                        ...
                                        <div class="widget-content">
                                            ...
                                            <div class="row" style="margin-top: 50px; text-align: center;">
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce1.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '1'): ?> checked <?php endif; ?> value="1" class="new-control-input chooseTemplate">
                                                ...
                                                <!-- template 2 -->
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce2.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '2'): ?> checked <?php endif; ?> value="2" class="new-control-input chooseTemplate">
                                                            <span class="new-control-indicator"></span> .
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- template 3 -->
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce3.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '3'): ?> checked <?php endif; ?> value="3" class="new-control-input chooseTemplate">
                                                            <span class="new-control-indicator"></span> .
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- template 4 -->
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce4.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '4'): ?> checked <?php endif; ?> value="4" class="new-control-input chooseTemplate">
                                                            <span class="new-control-indicator"></span> .
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- template 5 -->
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce5.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '5'): ?> checked <?php endif; ?> value="5" class="new-control-input chooseTemplate">
                                                            <span class="new-control-indicator"></span> .
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- template 6 -->
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce6.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '6'): ?> checked <?php endif; ?> value="6" class="new-control-input chooseTemplate">
                                                            <span class="new-control-indicator"></span> .
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- template 7 -->
                                                <div class="col-md-4" style="margin:0px auto 30px auto">
                                                    <img src="<?php echo e(Path::asset('images/announce7.jpg')); ?>" alt="" style="width: 250px; height:150px" class="img-responsive">
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="chooseTemplate" <?php if($announce->template == '7'): ?> checked <?php endif; ?> value="7" class="new-control-input chooseTemplate">
                                                            <span class="new-control-indicator"></span> .
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6" style="left:0px; right:0px; margin: auto;">
                                                    <br><br><br>
                                                    <button href="javascript:void(0);" class="btn btn-primary" style="display:block; margin: auto;" onclick="window.open('<?php echo e(Variables::tvPath("announce.html")); ?>', 'newwindow', 'width=1600, height=860'); return false;">Preview Live Page</button>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-8 col-sm-12 col-12 layout-spacing" style="margin: 40px auto 0px auto; ">
                                    <div class="widget widget-card-two" style="border:2px solid var(--dashboardCard)">
                                        <div class="widget-content">
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <div style=" position:absolute; top:10px; right: 10px;">
                                                        <p>Last Session is </p>
                                                        <?php if(strtotime(date("Y-m-d H:i:s", strtotime($settings->time_zone.' hour'))) <= strtotime($announce->end)): ?>
                                            ...
                                            <?php if($announce): ?>
                                            <form action="<?php echo e(route('announcement.store')); ?>" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                                                <div class="card-bottom-section">
                                                    <div class="row" style="margin-top: 30px; padding:30px">
                                                        <div class="<?php if($announce->template == 1): ?> col-md-12 <?php else: ?> col-md-6 <?php endif; ?>">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="contact-occupation">
                                                                                <label for=""><b>Start Date</b> <Br> <span class="text-primary"><?php echo e(date('d M, Y. h:i a', strtotime($announce->start))); ?></span></label>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group mb-4">
                                                                                <label for=""><b>End Date</b> <br> <span class="text-primary"><?php echo e(date('d M, Y. h:i a', strtotime($announce->end))); ?></span> </label>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group mb-4">
                                                                        ...
                                                                        <input type="text" name="title" class="form-control mb-4" value="<?php echo e($announce->title); ?>" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group mb-4">
                                                                        ...
                                                                        <input type="color" name="color" class="form-control mb-4" value="<?php echo e($announce->color); ?>" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group mb-4">
                                                                        ...
                                                                        <textarea type="text" name="text" rows="5" class="form-control mb-4" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)"><?php echo e($announce->text); ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <?php if($announce->template != 1): ?>
                                                        <div class="col-md-6">
                                                            <div class="row">
...
<script>
    $(".chooseTemplate").change(function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('announcement.update')); ?>",
            data: {
                template: template,
                _token: _token
            },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/Client/announcement.blade.php ENDPATH**/ ?>