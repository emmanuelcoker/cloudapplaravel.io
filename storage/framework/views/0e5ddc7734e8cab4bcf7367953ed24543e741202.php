<div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 col-12 layout-spacing" style="margin: 40px auto 0px auto; ">
                    ...
                    <div class="card-bottom-section">
                        ...
                        <div class="row" style="margin-top: 50px;">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px">
                                <img src="<?php echo e(Path::asset('images/1b.jpg')); ?>" alt="" style="width: 300px; height:200px"  class="img-responsive">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px">
                                <img src="<?php echo e(Path::asset('images/2b.jpg')); ?>" alt="" style="width: 300px; height:200px"  class="img-responsive">
                                <div class="n-chk" style="margin-top: 15px;">
                                    <label class="new-control new-checkbox checkbox-success">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px">
                                <img src="<?php echo e(Path::asset('images/3b.jpg')); ?>" alt="" style="width: 300px; height:200px"  class="img-responsive">
                                <div class="n-chk" style="margin-top: 15px;">
                                    <label class="new-control new-checkbox checkbox-success">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px">
                                <img src="<?php echo e(Path::asset('images/4b.jpg')); ?>" alt="" style="width: 300px; height:200px"  class="img-responsive">
                                <div class="n-chk" style="margin-top: 15px;">
                                    <label class="new-control new-checkbox checkbox-success">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px">
                                <img src="<?php echo e(Path::asset('images/5b.jpg')); ?>" alt="" style="width: 300px; height:200px"  class="img-responsive">
                                <div class="n-chk" style="margin-top: 15px;">
                                    <label class="new-control new-checkbox checkbox-success">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px">
                                <img src="<?php echo e(Path::asset('images/fx_template.jpg')); ?>" alt="" style="width: 300px; height:200px"  class="img-responsive">
                                <div class="n-chk" style="margin-top: 15px;">
                                    <label class="new-control new-checkbox checkbox-success">
        ...
        </div><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/livewire/template.blade.php ENDPATH**/ ?>