...
} elseif ($_instance->childHasBeenRendered('9uWD3VD')) {
    $componentId = $_instance->getRenderedChildComponentId('9uWD3VD');
    $componentTag = $_instance->getRenderedChildComponentTagName('9uWD3VD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9uWD3VD');
} else {
    $response = \Livewire\Livewire::mount('industry', [$settings->industry_id]);
    $html = $response->html();
    $_instance->logRenderedChild('9uWD3VD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('6aWZcZP')) {
    $componentId = $_instance->getRenderedChildComponentId('6aWZcZP');
    $componentTag = $_instance->getRenderedChildComponentTagName('6aWZcZP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6aWZcZP');
} else {
    $response = \Livewire\Livewire::mount('sections');
    $html = $response->html();
    $_instance->logRenderedChild('6aWZcZP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('7ca0w68')) {
    $componentId = $_instance->getRenderedChildComponentId('7ca0w68');
    $componentTag = $_instance->getRenderedChildComponentTagName('7ca0w68');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7ca0w68');
} else {
    $response = \Livewire\Livewire::mount('training-settings');
    $html = $response->html();
    $_instance->logRenderedChild('7ca0w68', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.client.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/superadmin/global_settings.blade.php ENDPATH**/ ?>