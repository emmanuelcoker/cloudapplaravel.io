...
<?php if(Permission::check('can_update_rate')): ?>
    <div class="row" style="width: 155%;">
        <div class="col-md-6 " style="left: 0px; right: 0px; margin:10px auto 40px auto;">
            <div style="display: inline-block;">
                <a class="btn btn-success" href="#" role="button" id="pendingTask" data-toggle="modal" data-target="#pta" aria-haspopup="true" aria-expanded="false">
            ...
            &nbsp;&nbsp;
            <div style="display: inline-block;">
                <a class="btn btn-primary" href="#" role="button" id="pendingTask" data-toggle="modal" data-target="#addPta" aria-haspopup="true" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right">
  ...
  <?php endif; ?>
    ...
    <div class="items items-header-section">
        <div class="item-content">
            ...
            <div class="user-email" style="width: 30%; text-align: center;">
                <h4 style="margin-left: -60px; color:var(--blackText)">Currency</h4>
            </div>
            <div class="user-location" style="width: 30%; text-align: center;">
                <h4 class="text-center" style="margin-left: -10px; color:var(--blackText)">Value</h4>
            </div>
            <?php if(Permission::check('can_update_rate')): ?>
    ...
    <form action="#" wire:submit.prevent="save">
        <?php $__currentLoopData = $ptas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="items">
            <div class="item-content">
                <div class="user-profile" style="width: 20%; text-align: left;">
                    ...
                    <img src="<?php echo e(Variables::tvPath('flag/'.$pta->currency.'.png')); ?>" style="width:70px; height:70px; margin-left:40px" alt="">
                ...
                <div class="user-email" style="width: 30%; text-align: center;">
                    ...
                    <div class="form-group " style="width: 70%; margin:auto;">
                        ...
                        <select wire:model="currency.<?php echo e($x); ?>" class="form-control mb-4" required style="background:var(--inputBackground); color:var(--inputColor); border:2px solid var(--imgBorder)">
                            <option value="<?php echo e($pta->currency); ?>"><?php echo e($pta->currency); ?></option>
                ...
                <?php if(Permission::check('can_update_rate')): ?>
                <div class="action-btn" style="width: 20%; text-align: right;">
                    <a href="#" wire:click="delete('<?php echo e($pta->id); ?>')">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2  delete-multiple">
                            <polyline points="3 6 5 6 21 6"></polyline>
                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                            <line x1="10" y1="11" x2="10" y2="17"></line>
    ...
    <!-- add pta Modal -->
    <div class="modal fade" wire:ignore.self id="addPta" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background:var(--dashboardCard)">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle" style="color:var(--blackText)"><b>Add <?php echo e($tabs->tab2); ?></b></h5>
...
</div><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/livewire/p-t-a.blade.php ENDPATH**/ ?>