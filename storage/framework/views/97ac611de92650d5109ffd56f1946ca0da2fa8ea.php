...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(Path::asset('admin/plugins/jquery-step/jquery.steps.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(Path::asset('admin/assets/css/elements/alert.css')); ?>">
...
<body class="sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="javascript:void(0)">
                        <img src="<?php echo e(Path::asset('images/setupLoago.png')); ?>" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <div class="row" style="">
                ...
                <div class="col-md-12">
                    ...
                    <div class="alert alert-light-danger border-0 mb-4" role="alert">
                        ...
                        <strong></strong><?php echo e($error); ?></button>
                    </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12" style="margin-top:170px">
                    <form method="post" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                                        ...
                                        <section class="pricing-section bg-7 mt-5">
                                            <div class="pricing pricing--norbu">
                                                ...
                                                <div class="pricing__item">
                                                    ...
                                                    <h3 class="pricing__title"><?php echo e($plan->name); ?></h3>
                                                    <div class="pricing__price"><span class="pricing__currency">$</span><small><?php echo e(number_format($plan->price)); ?></small><span class="pricing__period">/ month</span></div>
                                                    ...
                                                    <div class="n-chk" style="margin-top: 15px;">
                                                        <label class="new-control new-checkbox checkbox-success">
                                                            <input type="radio" name="plan_id" value="<?php echo e($plan->id); ?>" <?php if($plan->id == 2): ?> checked <?php endif; ?> class="new-control-input" >
                                                        ...
                                                        <div class="form">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control mb-4" name="path_id" id="exampleFormControlSelect1" required>
                                                                    ...
                                                                    <option value="<?php echo e($path->id); ?>"><?php echo e($path->path); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control mb-4" id="fullName" placeholder="Company Name" value="<?php echo e(session()->get('company')); ?>" name="company_name" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control mb-4" name="company_country" id="exampleFormControlSelect1" required>
                                                                    <option value="<?php echo e(session()->get('country')); ?>"><?php echo e(App\Models\Country::find(session()->get('country'))['name']); ?></option>
  ...
  <p id="length" class="invalid">Minimum <b>8 characters</b></p>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row text-center">
                                                                        <div class="col-md-4" style="margin: 0px auto 20px auto">
                                                                            <img src="<?php echo e(Path::asset('images/1b.jpg')); ?>" alt="" style="width: 150px; height:100px" class="img-responsive">
                                                                            <div class="n-chk" style="margin-top: 15px;">
                                                                                <label class="new-control new-checkbox checkbox-success">
                                                                        ...
                                                                        <div class="col-md-4" style="margin: 0px auto 20px auto">
                                                                            <img src="<?php echo e(Path::asset('images/2b.jpg')); ?>" alt="" style="width: 150px; height:100px" class="img-responsive">
                                                                            <div class="n-chk" style="margin-top: 15px;">
                                                                                <label class="new-control new-checkbox checkbox-success">
                                                                        ...
                                                                        <div class="col-md-4" style="margin: 0px auto 20px auto">
                                                                            <img src="<?php echo e(Path::asset('images/3b.jpg')); ?>" alt="" style="width: 150px; height:100px" class="img-responsive">
                                                                            <div class="n-chk" style="margin-top: 15px;">
                                                                                <label class="new-control new-checkbox checkbox-success">
                                                                        ...
                                                                        <div class="col-md-4" style="margin: 0px auto 20px auto">
                                                                            <img src="<?php echo e(Path::asset('images/4b.jpg')); ?>" alt="" style="width: 150px; height:100px" class="img-responsive">
                                                                            <div class="n-chk" style="margin-top: 15px;">
                                                                                <label class="new-control new-checkbox checkbox-success">
                                                                        ...
                                                                        <div class="col-md-4" style="margin: 0px auto 20px auto">
                                                                            <img src="<?php echo e(Path::asset('images/5b.jpg')); ?>" alt="" style="width: 150px; height:100px" class="img-responsive">
                                                                            <div class="n-chk" style="margin-top: 15px;">
                                                                                <label class="new-control new-checkbox checkbox-success">
                                                                        ...
                                                                        <div class="col-md-4" style="margin: 0px auto 20px auto">
                                                                            <img src="<?php echo e(Path::asset('images/fx_template.jpg')); ?>" alt="" style="width: 150px; height:100px" class="img-responsive">
                                                                            <div class="n-chk" style="margin-top: 15px;">
                                                                                <label class="new-control new-checkbox checkbox-success">
    ...
    <script src="<?php echo e(Path::asset('admin/plugins/jquery-step/jquery.steps.min.js')); ?>"></script>
    <script src="<?php echo e(Path::asset('admin/plugins/jquery-step/custom-jquery.steps.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\CloudAppLaravel\resources\views/setup/index.blade.php ENDPATH**/ ?>