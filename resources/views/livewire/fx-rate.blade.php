            ...
            <div class="items">
                <div class="item-content">
                    <div class="user-profile" style="width: 20%; text-align: left;">
                        ...
                        <img src="{{Variables::tvPath('flag/'.$rate->currency.'.png')}}" style="width:70px; height:70px; margin-left:40px" alt="">
                    </div>
                    ...
                    <div class="user-email" style="width: 20%;">
                        <div class="form-group" style="width: 70%;   float:right">
                            ...
                            <input type="text" wire:model="buy.{{$y}}" class="form-control mb-4" required style="background:var(--inputBackground); color:var(--inputColor); border:2px solid var(--imgBorder)">
                        </div>
                    </div>
                    <div class="user-email" style="width: 20%; ">
                        ...
                        <div class="form-group" style="width: 70%;   float:right">
                            ...
                            <input type="text" wire:model="sell.{{$z}}" class="form-control mb-4" required style="background:var(--inputBackground); color:var(--inputColor); border:2px solid var(--imgBorder)">
                        </div>
                    </div>
                    @if(Permission::check('can_update_rate'))
                    <div class="action-btn" style="width: 20%; text-align: right;">
                        <a href="#" wire:click="delete('{{$rate->id}}')">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background:var(--dashboardCard)">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle" style="color:var(--blackText)"><b>Add {{$tabs->tab1}}</b></h5>
                ...
                <form wire:submit.prevent="add">
                    <div class="modal-body">
                        <div class="row" style="margin: auto;">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" wire:model="b" class="form-control mb-4" placeholder="{{$tabs->tab5}} value" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" wire:model="s" class="form-control mb-4" placeholder="{{$tabs->tab6}} value" required style="background-color:var(--inputBackground) !important; color:var(--inputColor); border:2px solid var(--imgBorder)">
                                </div>
                            </div>
                        </div>
