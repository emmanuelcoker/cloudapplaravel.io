    ...
    <div class="items">
        <div class="item-content" style="min-width: 100%;  ">
            <div class="user-profile" style="width: 25%; text-align: center;">
                ...
                <p class="user-work" data-name="{{$location->name}}" style="font-size: 14px; display: block; margin-left: 40px; color:var(--tableFontColor)">{{$location->name}}</p>
            </div>
            ...
            <div class="user-email" style="width: 25%; text-align: center;">
                <div class="user-meta-info">
                    <p class="user-work" style="font-size: 14px; display: block; margin-left: 40px;" data-occupation="{{$location['country']['name']}}">{{$location['country']['name']}}</p>
                </div>
            </div>

            <div class="user-email" style="width: 25%; text-align: center;">
                <div class="user-meta-info">
                    <p class="user-work" style="font-size: 14px; display: block; margin-left: 40px;" data-occupation="{{count($location['tvs'])}}">{{count($location['tvs'])}}</p>
                </div>
            </div>

            <div class="action-btn" style="width: 25%; text-align: right;">
                <a href="#" wire:click="setupEdit('{{$location->id}}')" data-toggle="modal" data-target="#editLocation">
                ...
                <a href="#" wire:click="delete('{{$location->id}}')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2  delete-multiple">
                ...
                &nbsp;&nbsp;
                <a href="#" data-toggle="modal" wire:click="getLocationDetail('{{$location->id}}')" data-target="#locationDetail">
                ...
                &nbsp;&nbsp;
                <a href="#" data-toggle="modal" wire:click="getDisplays('{{$location->id}}')" data-target="#displays">
                ...
                @if($settings['add_display'])
                <a href="#" wire:click="setLocation('{{$location->id}}')" data-toggle="modal" data-target="#addDisplay">
            ...
            <div class="modal-content" style="background:var(--dashboardCard)">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">
                        <b><span id="uploadTitle" style="color:var(--blackText)"><span class="text-success" >{{$locationDetails['name']}} </span> Location</span></b>
                    </h5>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['name']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Location Address</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['address']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Country</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['country']['name']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>State</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['state']['name']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>City</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['city']['name']}}</p>
                                <br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['supervisor']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Supervisor Email</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['supervisor_email']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Supervisor Phone</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['supervisor_phone']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Manager</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['manager']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Manager Email</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['manager_email']}}</p>
                                <br>
                            </div>

                            <div class="col-md-12">
                                <h5 style="color:var(--blackText)"><b>Manager Phone</b></h5>
                                <p style="font-size: 16px; color:var(--tableFontColor)">{{$locationDetails['manager_phone']}}</p>
                                <br>
                            </div>
                        </div>
                    </div>
    ...
    <div wire:ignore.self class="modal fade" id="displays" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content" style="padding: 10px; background:var(--dashboardCard)">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">
                        <b><span id="uploadTitle" style="color:var(--blackText)"><span class="text-success">{{$displayName}}</span> Display</span> </b>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x">
                            <line x1="18" y1="6" x2="6" y2="18"></line>
                ...
                <div class="items">
                    <div class="item-content" style="min-width: 100%;  ">
                        <div class="user-profile" style="width: 20%; text-align: center;">
                            ...
                            <p class="user-name" data-name="{{$display->name}}" style="font-size: 14px; display: block; margin-left: 40px; color:var(--tableFontColor)">{{$display->name}}</p>
                        </div>

                        <div class="user-email" style="width: 20%; text-align: center;">
                            <div class="user-meta-info">
                                <p class="user-name" data-name="{{$display['zone']['name']}}" style="font-size: 14px; display: block; margin-left: 40px; color:var(--tableFontColor)">{{$display['zone']['name']}}</p>
                            </div>
                        </div>

                        <div class="user-email" style="width: 20%; text-align: center;">
                            <div class="user-meta-info">
                                <p class="user-name" data-name="Display{{$display->displayID}}" style="font-size: 14px; display: block; margin-left: 40px; color:var(--tableFontColor)">Display{{$display->displayID}}</p>
                            </div>
                        </div>
                        ...
                        <div class="user-email" style="width: 20%; text-align: center;">
                            <div class="user-meta-info" style="display: block; margin-left: 60px;"">
                                ...
                                <input @if($display->is_active) checked @endif type="checkbox" wire:change="switch('{{$display->id}}')" >
                        ...
                        <div class="action-btn" style="width: 20%; text-align: right;">
                            ...
                            <a href="{{route('changeTv', $display['id'])}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit">
                                    <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                </svg>
                            </a>

                            <a href="#" wire:click="deleteDisplay('{{$display->id}}')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2  delete-multiple">
                                    <polyline points="3 6 5 6 21 6"></polyline>
                                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                                    <line x1="10" y1="11" x2="10" y2="17"></line>
                            ...
                            <a href="#" onclick="window.open('{{Variables::displayUrl($display->name)}}', 'newwindow', 'width=1300, height=720'); return false;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
