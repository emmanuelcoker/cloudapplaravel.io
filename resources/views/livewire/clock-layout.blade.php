<div class="row" style="margin-top: 30px;">
    ...
    <div class="col-md-8" style="left:0px; right: 0px; margin:auto">
        ...
        <br><br>
        <iframe src="{{Path::asset('clock/'.$layout.'/index.html')}}" scrolling="no" style="border:none; overflow:hidden; " width="400" height="200" style="display:block; margin-left:-50px">
        </iframe>
    </div>
</div>