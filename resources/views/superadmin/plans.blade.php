                    ...
                    <div class="pricing__item" style="background:var(--dashboardCard); color: var(--blackText)">
                        <!-- <div class="operations1">
                            <a href="#" data-toggle="modal" data-target="#edit" class="btn btn-primary" onclick="
                                ...
                                document.getElementById('planName').innerHTML = '{{$plan->name}}';"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                    <path d="M12 20h9"></path>
                                    <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                </svg></a>
                        </div> -->
                        <div class="operations2">
                            <a href="{{route('plan.delete', $plan->id)}}" class="btn btn-danger"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2">
...
<div class="modal fade" id="plan" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="addContactModalTitle" method="post" action="{{route('plan.store')}}" enctype="multipart/form-data">
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="addContactModalTitle" method="post" action="{{route('plan.update')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <div class="n-chk">
                                                        <label class="new-control new-checkbox new-checkbox-text checkbox-success">
                                                            <input type="checkbox" name="features[]" value="{{$feature->id}}" class="new-control-input">
                                                            <span class="new-control-indicator"></span><span class="new-chk-content"> &nbsp; {{$feature->item}}</span>
                                                        </label>
                                                    </div>
                                                    @endforeach
                                                </div>
