...
<div id="loaderBody">
    ...
    <div class="news " >
            <div class="flex " >
                <div class="myHeader1" style="width:100%; ">
                {{$tab->news_title}}
            </div>
            </div>
        </div>
        <div class="marquee">
            ...
            @foreach($custom_news as $news)
                                @if($news->is_active)
                                <img src="rss/images/{{$news->image}}" style=" border-radius:38%; width:40px; height:40px; margin-bottom:-15px"></img> {{$news->name}}
                                <div class='vl'></div>
                                &nbsp;{{$news->content}} &nbsp;
                                <div class='vl'></div>
                                @endif
