...
<input type="hidden" name="cur_update_key" value="<?php echo rand(99999999999999, 300000000000000) . 'update' . rand(99999999999999, 700000000000000) ?>">
    ...
    <div  style="display:none;margin:0 -8px 0 auto;"  class="html5gallery" data-bgcolor="transparent"  data-autoslide="true" data-thumbheight="100" data-titleautohide="false" data-showtitle="false"  data-thumbwidth="360" data-autoplayvideo="true" data-skin="vertical" data-width="600" data-height="360" data-resizemode="fill" data-carouselbgcolorstart="#000" data-responsive="true" data-showimagetoolbox="always" data-carouselposition="left" data-thumbmargin="12"  data-thumbgap="6">
        ...
        <div class="row">
            ...
            <div class="videoSection col-md-12 col-lg-12 col-sm-12 padOff">
                ...
                <div class="row underVideo">
                    ...
                    <div class="col-md-4 padRightOff" style="margin-top: -4.6px; margin-left: -14px;"">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 padLeftOff">
                                @if($tv->clockLayout == 5)
                                @if($tv->show_date_image == 1)
                                <div class="tm" style="margin-top: -7%;  margin-left:-10px; background-image: url('time/{{$tv->clockImage}}'); background-size: 100% 100%;">
                                    @endif

                                    @if($tv->show_date_image == 0)
                                    <div class="tm" style="margin-top: -7%;  margin-left:-10px; background:{{$tv->clock_background_color}}; padding-bottom: 10px;">
                                        @endif
                                        ...
                                        <div id="info-box">
                                            <div class="responses" style="text-align: center;">
                                                ...
                                                @endif
                                                @if($tv->show_time == 1)
                                                <div id="calendar" style="margin-top: 25px;margin-bottom:10px;margin-left: 45px;font-size: 20px"></div>
                                                @endif



                                                <div class="row naviMenu" style="margin-left: 10px">
                                                    <!-- <p id="hour"></p>
<p id="minute"></p> -->
                                                    @if($tv->show_time == 1)
                                                    <ul style="">
...
<p id="minute"></p> -->
                                ...
                                @else
                                <iframe  src="{{$app_url}}{{Variables::tvPath('clock/'.$tv->clockLayout.'/index.html')}}" scrolling="no" style=" width: 100%; height: 100%; border: none; margin-top:-30px; padding: 0; overflow:hidden;  "></iframe>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="width:101%">
                        ...
                        <div class="row">
                            <div class="col-md-8 padLeftOff"  >
                                    <div class="slide2" style="width:115%">
                            ...
                            <div class="col-md-4 padLeftOff" style="display:block; margin-top:10px; " >
                                <a data-target=".check-networ" id="template_logo" data-toggle="modal" id="check-network" type="button">

                                    <div class="slide1" style="width:75%; margin-left:68px"> 
