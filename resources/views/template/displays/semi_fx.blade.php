...
<body style="background-color:{{$settings->tv_background}}">
    ...
    @foreach($medias as $media)
                ...
                <div class="tm" style="margin-top: 0%;  margin-left:-15px; background-image: url('time/{{$tv->clockImage}}'); background-size: 100% 100%;">
                    @endif

                    @if($tv->show_date_image == 0)
                    <div class="tm" style="margin-top: 0%;  margin-left:-15px; background:{{$tv->clock_background_color}}; padding-bottom:13px">
                        @endif
...
<p id="minute"></p> -->
                    ...
                    @else
                                <iframe  src="{{$app_url}}{{Variables::tvPath('clock/'.$tv->clockLayout.'/index.html')}}" scrolling="no" style=" width: 107%; height: 100%; border: none; margin:0px 0px 0px -30px; padding: 0; overflow:hidden;  "></iframe>
                                @endif
                </div>
...
Sorry your browser does not support inline frames.
        ...
        <a href="{{$app_url}}{{Variables::tvPath('sliderengine/initslider-1.js')}}"></a>
        <a href="{{$app_url}}{{Variables::tvPath('sliderengine/jquery.js')}}"></a>
