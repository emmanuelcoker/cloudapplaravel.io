                ...
                <div class="widget-content widget-content-area rounded-pills-icon">
                    ...
                    <div class="tab-content" id="rounded-pills-icon-tabContent">
                        ...
                        <div class="tab-pane fade" id="rounded-title" role="tabpanel" aria-labelledby="rounded-pills-icon-profile-tab">
                            <div class="media">
                                <div class="media-body">
                                    <form method="post" action="{{route('rate_tab_store')}}"> @csrf
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6" style="left: 0pc; right: 0px; margin:auto">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="tab1" class="form-control mb-4" required style="background:var(--inputBackground); color:var(--inputColor); border:2px solid var(--imgBorder)" value="{{$tabs->tab1}}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6" style="left: 0pc; right: 0px; margin:auto">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="tab2" class="form-control mb-4" required style="background:var(--inputBackground); color:var(--inputColor); border:2px solid var(--imgBorder)" value="{{$tabs->tab2}}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6" style="left: 0pc; right: 0px; margin:auto">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="tab3" class="form-control mb-4" required style="background:var(--inputBackground); color:var(--inputColor); border:2px solid var(--imgBorder)" value="{{$tabs->tab3}}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="background:var(--dashboardCard)">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle" style="color:var(--blackText)"><b>Update {{$tabs->tab3}}</b></h5>
            ...
            <div class="modal-body">
                <form action="{{route('interestRate1.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row" style="margin: 20px 0px;">
                        <div class="col-md-12 mb-12" style="margin-bottom: 10px ;">
                            <h4 class="text-center " style="color:var(--blackText)">Download {{$tabs->tab3}} file sample&nbsp; <a style="color:white" href="{{Path::asset('file Samples/Interest Rate 1.xlsx')}}" download class="btn btn-success btn-small">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="background:var(--dashboardCard)">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle" style="color:var(--blackText)" >Update {{$tabs->tab1}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x">
                        <line x1="18" y1="6" x2="6" y2="18"></line>
                        <line x1="6" y1="6" x2="18" y2="18"></line>
            ...
            <div class="modal-body">
                <form action="{{route('rates.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin: 20px 0px;">
                        <div class="col-md-12 mb-12" style="margin-bottom: 10px ;">
                            <h4 class="text-center" style="color:var(--blackText)">Download {{$tabs->tab1}} file sample &nbsp;&nbsp; <a style="color:white" href="{{Path::asset('file Samples/FX-RATE.xlsx')}}" download class="btn btn-success btn-small">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <path d="M15 10h4l-7 8-7-8h4v-10h6v10zm3.213-8.246l-1.213 1.599c2.984 1.732 5 4.955 5 8.647 0 5.514-4.486 10-10 10s-10-4.486-10-10c0-3.692 2.016-6.915 5-8.647l-1.213-1.599c-3.465 2.103-5.787 5.897-5.787 10.246 0 6.627 5.373 12 12 12s12-5.373 12-12c0-4.349-2.322-8.143-5.787-10.246z" />
                                    </svg>
                                </a></h4>
...
<div class="modal fade" id="pta" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="background:var(--dashboardCard)">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle" style="color:var(--blackText)"><b>Update {{$tabs->tab2}}</b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x">
                        <line x1="18" y1="6" x2="6" y2="18"></line>
                        <line x1="6" y1="6" x2="18" y2="18"></line>
            ...
            <div class="modal-body">
                <form action="{{route('pta.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row" style="margin: 20px 0px;">
                        <div class="col-md-12 mb-12" style="margin-bottom: 10px ;">
                            <h4 class="text-center" style="color:var(--blackText)">Download {{$tabs->tab2}} file sample&nbsp; <a style="color:white" href="{{Path::asset('file Samples/PTA-RATE.xlsx')}}" download class="btn btn-success btn-small">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                        <path d="M15 10h4l-7 8-7-8h4v-10h6v10zm3.213-8.246l-1.213 1.599c2.984 1.732 5 4.955 5 8.647 0 5.514-4.486 10-10 10s-10-4.486-10-10c0-3.692 2.016-6.915 5-8.647l-1.213-1.599c-3.465 2.103-5.787 5.897-5.787 10.246 0 6.627 5.373 12 12 12s12-5.373 12-12c0-4.349-2.322-8.143-5.787-10.246z" />
                                    </svg>
                                </a></h4>
