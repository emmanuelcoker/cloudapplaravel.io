...
<link href="{{Path::asset('admin/assets/css/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
<link href="{{Path::asset('admin/assets/css/dashboard/dash_2.css')}}" rel="stylesheet" type="text/css" />
<!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
<link href="{{Path::asset('admin/assets/css/elements/infobox.css')}}" rel="stylesheet" type="text/css" />
<style>
    .myLocation {
        border-radius: 30px;
        padding: 10px 20px;
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="infobox-1 text-center" style="width: 100%; padding:43px 0px; background:var(--dashboardCard); border: 1px solid var(--dashboardCard)">
                <h5 class="info-heading" style="color:var(--blackText)">Welcome Back ({{Auth::user()['role']['name']}}) </h5>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
            <div class="infobox-1 text-center" style="width: 100%; background:var(--dashboardCard); border: 1px solid var(--dashboardCard)">
                <div class="row">
                    ...
                    <div class="col-md-5 text-center">
                        <div  >
                            <h5 class="info-heading" style="color:var(--blackText)"> {{Auth::user()->name}} </h5>
                            <p class="info-text" style="color:var(--blackText)">{{Auth::user()->email}}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget-four">
                <div class="widget-heading">
                    <h5 class="" style="color:var(--blackText)">{{$tab->training}} Summary</h5>
                </div>
                <div class="widget-content">
                        ...
                        <div class="browser-list">
                            ...
                            <div class="w-browser-details">
                                <div class="w-browser-info">
                                    ...
                                    <p class="browser-count">{{$morning}}</p>
                                </div>
                                <div class="w-browser-stats">
                                    <div class="progress">
                                        <div class="progress-bar bg-gradient-primary" role="progressbar" style="width: {{$morning}}0%" aria-valuenow="{{$morning}}0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="browser-list">
                            ...
                            <div class="w-browser-details">
                                ...
                                <div class="w-browser-info">
                                    ...
                                    <p class="browser-count">{{$afternoon}}</p>
                                </div>

                                <div class="w-browser-stats">
                                    <div class="progress">
                                        <div class="progress-bar bg-gradient-danger" role="progressbar" style="width:{{$afternoon}}0%" aria-valuenow="{{$afternoon}}0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                        ...
                        <div class="browser-list">
                            ...
                            <div class="w-browser-details">
                                ...
                                <div class="w-browser-info">
                                    ...
                                    <p class="browser-count">{{$evening}}</p>
                                </div>

                                <div class="w-browser-stats">
                                    <div class="progress">
                                        <div class="progress-bar bg-gradient-warning" role="progressbar" style="width: {{$evening}}0%" aria-valuenow="{{$evening}}0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                    ...
                    <div class="widget widget-one_hybrid widget-followers">
                        <div class="widget-heading">
                            <div class="w-title">
                                ...
                                <div class="">
                                    <p class="w-value" style="color:var(--blackText)">{{$logos}}</p>
                                    <h5 class="">Logos</h5>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="widget widget-one_hybrid widget-referral">
                        <div class="widget-heading">
                            <div class="w-title">
                                ...
                                <div class="">
                                    <p class="w-value" style="color:var(--blackText)">{{$faqs}}</p>
                                    <h5 class="">Faqs</h5>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="widget widget-one_hybrid widget-engagement">
                        <div class="widget-heading">
                            <div class="w-title">
                                ...
                                <div class="">
                                    <p class="w-value" style="color:var(--blackText)">{{$tutorials}}</p>
                ...
                <div class="widget-content">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="meta-date-time">{{$support->email}} <bR>Support Person</p>
                        </div>
                    </div>
                    ...
                    <div class="w-action">
                        ...
                        <div class="read-more">
                            <a href="{{route('support.index')}}">Help Desk <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-right">
            ...
            <div class="widget widget-card-two">
                <div class="widget-content">
                    ...
                    <div class="card-bottom-section">
                        ...
                        <div class="img-group">
                            @foreach($rsss as $rss)
                            <img src="{{Variables::tvPath('rss/images/'.$rss->image)}}" alt="avatar">
                            @endforeach
                        </div>
                        <br>
                        <a href="{{route('news.index')}}" class="btn">View RSS</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="widget-content">
                    ...
                    <div class="card-bottom-section">
                        ...
                        <div class="img-group">
                            ...
                            <img src="{{Variables::tvPath('rss/images/'.$news->image)}}" alt="avatar">
                            @endforeach
                        </div>
                        <br>
                        <a href="{{route('news.index')}}" class="btn">View Custom News</a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{Path::asset('admin/assets/js/dashboard/dash_1.js')}}"></script>
<script src="{{Path::asset('admin/assets/js/dashboard/dash_2.js')}}"></script>
@endsection