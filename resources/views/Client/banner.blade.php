                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                        ...
                        <div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
                            <div class="modal-dialog @if(Permission::check('can_upload_banners')) modal-xl @endif modal-dialog-centered" role="document">
                                            ...
                                            <div class="add-contact-box">
                                                <div class="add-contact-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="@if(Permission::check('can_upload_banners')) col-md-12 @else col-md-12 @endif" style="display: flex; justify-content: center;  align-items: center; text-align: center;">
                                                            <img id="showLastImage" src="" style="max-width: 50%; display:block; margin: auto;" alt="sd">
                                                            <br><br>
                                                        </div>
                                                        @if(Permission::check('can_upload_banners'))
                                                        <br><br>
                    ...
                    <div class="tab-content" id="rounded-pills-icon-tabContent">
                        <div class="tab-pane fade show active" id="rounded-pills-icon-home" role="tabpanel" aria-labelledby="rounded-pills-icon-home-tab">
                            <div class="searchable-items list">
                                ...
                                <div class="items" data-index="{{$banner->id}}" data-position="{{$banner->position}}">
                                    <div class="item-content" style="min-width: 100%;  ">
                                        <div class="user-profile" style="width: 20%; text-align: center;">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#addContactModal" onclick="var id = '{{$banner->id}}';  
                                            document.getElementById('bannerID').value = id;
                                            document.getElementById('showLastImage').src = '{{Variables::tvPath("banner/banner".$banner->file.".".$banner->extension)}}';
                                            document.getElementById('updateBannerNow').innerHTML= 'Update banner{{$banner->file}}';
                                            ">
                                                <img src="{{Variables::tvPath('banner/banner'.$banner->file.'.'.$banner->extension)}}" style="width:70px; height:70px; margin-left: 40px;" alt="">
                                            </a>
                                        ...
                                        <div class="user-email" style="width: 30%; text-align: center;">
                                            <div class="user-meta-info">
                                                <p class="user-work" style="text-align: center;" data-occupation="{{$banner->title}}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;({{$banner->type}})</p>
                                            </div>
                                        </div>

                                        <div class="user-email" style="width: 30%; text-align: center;">
                                            <p class="info-title">Name: </p>
                                            <p class="user-name" data-name="banner{{$banner->file}}" style="font-size: 14px; display: block; margin-left: 40px;">banner{{$banner->file}}</p>
                                        </div>

                                        <div class="action-btn" style="width: 10%; text-align: center;">
                                        <div style="margin-left:38px">
                                        <label class="switch s-outline s-outline-success  mb-4 mr-2" >
                                                                                                <input id="{{$banner->id}}" class="bannerSwitch" type="checkbox" @if($banner->is_active == true) checked @endif>
                                        ...
                                        <div class="action-btn" style="width: 10%; text-align: right;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit" onclick="var id = '{{$banner->id}}';  
                                            document.getElementById('bannerID').value = id;
                                            document.getElementById('showLastImage').src = '{{Variables::tvPath("banner/banner".$banner->file.".".$banner->extension)}}';
                                            document.getElementById('updateBannerNow').innerHTML= 'Update banner{{$banner->file}}';
                                            ">
